...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_file', help="Name of the output file", default="video4_spot_list.p")
...
# set_regions.py data/park.mp4 --out_file parkRegions
# set_regions.py data/video1.mp4 --out_file repo_spot/video1regions
# set_regions.py data/video2.mp4 --out_file repo_spot/video2regions
# set_regions.py data/video3.mp4 --out_file repo_spot/video3regions
# set_regions.py data/playing_cars.mp4 --out_file repo_spot/playing_cars_regions
##set_regions.py data/playing1.mp4 --out_file repo_spot/playing1regions
# set_regions.py data/frame.PNG --out_file repo_spot/frame_regions
# set_regions_image.py images_test/park1.PNG --out_file regions_test/park1_regions
# set_regions_image.py images_test/park2.jpg --out_file regions_test/park2_regions